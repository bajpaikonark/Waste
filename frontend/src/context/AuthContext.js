...
//   // Replace the normalizePhone function with:
...
//     try {
//       if (!confirmationResult) return { success: false, error: 'No OTP in progress' };
//       const result = await confirmationResult.confirm(code);
//       return { success: true, idToken: await result.user.getIdToken() };
//     } catch (error) {
