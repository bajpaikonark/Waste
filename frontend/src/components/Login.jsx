...
//   if (otpStep === 'verify') {
//     return <OTPVerification phoneNumber={phone} onVerify={handleOtpVerify} onResend={handleOtpResend} onCancel={() => setOtpStep('input')} />;
//   }
...
//               <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} className="mt-1 block w-full px-3 py-2 border rounded-md shadow-sm" required/>
//             </div>
//             <div>
//               <label className="block text-sm font-medium text-gray-700">Password</label>
//               <input type="password" value={password} onChange={(e)=>setPassword(e.target.value)} className="mt-1 block w-full px-3 py-2 border rounded-md shadow-sm" required/>
//             </div>
//             <button type="submit" disabled={loading} className="w-full py-2 px-4 bg-green-600 text-white rounded-md">{loading ? 'Logging in...' : 'Login'}</button>
//           </form>
...
//               <input type="tel" value={phone} onChange={(e)=>setPhone(e.target.value)} placeholder="1234567890" className="mt-1 block w-full px-3 py-2 border rounded-md shadow-sm" required pattern="[0-9]{10}"/>
//             </div>
//             <button type="submit" disabled={loading} className="w-full py-2 px-4 bg-green-600 text-white rounded-md">{loading ? 'Sending OTP...' : 'Login with OTP'}</button>
//           </form>
//         </>
//       ) : null}

//       <div className="mt-4 text-center">
//         <p className="text-sm text-gray-600">Don't have an account? <button onClick={() => navigate("/signup")} className="text-green-600 font-medium hover:text-green-500">Sign Up</button></p>
//       </div>
//     </div>
//   );
// };
