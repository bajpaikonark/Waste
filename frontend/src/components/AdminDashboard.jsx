...
//         <p className="text-gray-600">Manage waste reports submitted by users</p>
//       </div>
...
//                         <img className="h-10 w-10 rounded-full object-cover" src={report.imageUrl} alt={report.description} />
//                       </div>
//                       <div className="ml-4">
